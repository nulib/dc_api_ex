...
defmodule DcApiEx.Connection do
  @moduledoc """
  Handle Tesla connections for DcApiEx.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, DcApiEx.Connection,
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:dc_api_ex, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - DcApiEx 1.0.0 - elixir"
        )
      )
